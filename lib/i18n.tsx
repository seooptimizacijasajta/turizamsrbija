...
export const I18N: Record<string,{sr:string;en:string;de?:string}> = {
  ...
  nav_marketing: { sr: "Oglašavanje", en: "Advertising", de: "Werbung" },
  nav_hostguide: { sr: "Vodič za vlasnike", en: "Host guide", de: "Vermieter-Leitfaden" },
  nav_firme: { sr: "Firme", en: "Businesses", de: "Firmen" },
...
export const DE: Record<string, string> = {
  ...
  nav_marketing: "Werbung",
  nav_hostguide: "Vermieter-Leitfaden",
  nav_firme: "Firmen",
