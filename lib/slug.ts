...
export const KIND_TO_SLUG: Record<Kind, string> = {
  mountain: "planine", lake: "jezera", river: "reke", monastery: "manastiri", spa: "banje", ethno: "etno-sela", stay: "smestaj",
};
export const KIND_TO_SLUG_EN: Record<Kind, string> = {
  mountain: "mountains", lake: "lakes", river: "rivers", monastery: "monasteries", spa: "spas", ethno: "ethno-villages", stay: "accommodation",
};
export const SLUG_TO_KIND: Record<string, Kind> = {
  planine: "mountain", jezera: "lake", reke: "river", manastiri: "monastery", banje: "spa", "etno-sela": "ethno", smestaj: "stay",
};
export const SLUG_TO_KIND_EN: Record<string, Kind> = {
  mountains: "mountain", lakes: "lake", rivers: "river", monasteries: "monastery", spas: "spa", "ethno-villages": "ethno", accommodation: "stay",
};
export const KIND_TO_SLUG_DE: Record<Kind, string> = {
  mountain: "berge", lake: "seen", river: "fluesse", monastery: "kloester", spa: "kurorte", ethno: "ethno-doerfer", stay: "unterkunft",
};
export const SLUG_TO_KIND_DE: Record<string, Kind> = {
  berge: "mountain", seen: "lake", fluesse: "river", kloester: "monastery", kurorte: "spa", "ethno-doerfer": "ethno", unterkunft: "stay",
};
...
const CUSTOM_PAIRS: [string, string, string][] = [
  ...
  ["teme", "topics", "themen"],
  ["apartmani", "apartments", "apartments"],
  ["sobe", "rooms", "zimmer"],
  ["brvnare-i-kolibe", "log-cabins", "blockhuetten"],
  ["vikendice", "holiday-cottages", "ferienhaeuser"],
  ["kuce-za-izdavanje", "houses-for-rent", "haeuser-zur-miete"],
  ["hoteli", "hotels", "hotels"],
  ["seoski-turizam", "rural-tourism", "landtourismus"],
  ["grcka", "greece", "griechenland"],
  ["crna-gora", "montenegro", "montenegro"],
  ["hrvatska", "croatia", "kroatien"],
  ["bosna-i-hercegovina", "bosnia-and-herzegovina", "bosnien-herzegowina"],
  ...
  ["zanimljivosti", "curiosities", "wissenswertes"],
  ["putopisi", "travelogues", "reiseberichte"],
