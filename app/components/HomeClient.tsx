...
const CATS = [
  ...
  { kind: "monastery" as const, key: "nav_monasteries", img: "1548013146-72479768bada", sub: "Studenica · Žiča · Manasija" },
...
export default function HomeClient({ all, posts = [], events = [] }: { all: Listing[]; posts?: Post[]; events?: EventItem[] }) {
  ...
  const [type, setType] = useState<"mountain"|"lake"|"river"|"monastery"|"spa"|"ethno"|"stay">("mountain");
      ...
      <section className="hero">
        <div className="container hero-inner">
          ...
          <form className="searchbar" onSubmit={(e) => { e.preventDefault(); router.push(`${searchPath(lang)}?q=${encodeURIComponent(q)}&type=${type}`); }}>
            ...
            <select value={type} onChange={(e) => setType(e.target.value as "mountain"|"lake"|"river"|"monastery"|"spa"|"ethno"|"stay")}>
