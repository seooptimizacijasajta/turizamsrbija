...
export async function generateMetadata({ params }: { params: Promise<{ neighborhood: string }> }) {
  ...
  return { title: `Apartments Belgrad ${a.de} — Tagesmiete | Turizam Srbija`, description: `Apartments und Tagesmiete im Stadtteil ${a.de}, Belgrad. Geprüfte Unterkünfte mit Fotos, Karte und direktem Kontakt zum Gastgeber.`, alternates: { canonical: `/de/belgrad-apartments/${neighborhood}`, languages: { "sr-Latn-RS": `/apartmani-beograd/${neighborhood}`, en: `/en/belgrade-apartments/${neighborhood}`, de: `/de/belgrad-apartments/${neighborhood}`, "x-default": `/apartmani-beograd/${neighborhood}` } } };
}
