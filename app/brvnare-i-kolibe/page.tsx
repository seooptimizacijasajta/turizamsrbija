...
const ST = stayTypeByKey('brvnara')!;
const ALT = { "sr-Latn-RS": "/brvnare-i-kolibe", en: "/en/log-cabins", de: "/de/blockhuetten", "x-default": "/brvnare-i-kolibe" };
...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    alternates: { canonical: "/brvnare-i-kolibe", languages: ALT },
