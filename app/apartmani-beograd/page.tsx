...
export const metadata = { title: "Apartmani Beograd — stan na dan i privatni smeštaj | Turizam Srbija", description: "Apartmani u Beogradu i stan na dan — proveren privatni smeštaj po naseljima (Vračar, Novi Beograd, Zemun), od studija do luksuznih stanova. Bez provizije za gosta.", alternates: { canonical: "/apartmani-beograd", languages: { "sr-Latn-RS": "/apartmani-beograd", en: "/en/belgrade-apartments", de: "/de/belgrad-apartments", "x-default": "/apartmani-beograd" } } };
