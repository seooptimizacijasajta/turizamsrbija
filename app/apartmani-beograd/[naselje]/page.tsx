...
export async function generateMetadata({ params }: { params: Promise<{ naselje: string }> }) {
  ...
  return { title: `Apartmani Beograd ${a.sr} — stan na dan | Turizam Srbija`, description: `Apartmani i stan na dan u naselju ${a.sr} u Beogradu. Proveren smeštaj sa fotografijama, mapom i direktnim kontaktom vlasnika, bez provizije za gosta.`, alternates: { canonical: `/apartmani-beograd/${naselje}`, languages: { "sr-Latn-RS": `/apartmani-beograd/${naselje}`, en: `/en/belgrade-apartments/${naselje}`, de: `/de/belgrad-apartments/${naselje}`, "x-default": `/apartmani-beograd/${naselje}` } } };
}
