...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return { title: `${p.title_en} | Turizam Srbija`, description: p.excerpt_en || p.title_en, openGraph: { images: [p.cover_image || `/api/og?title=${encodeURIComponent(p.title_en)}`] }, alternates: { canonical: `/en/blog/${slug}`, languages } };
}
