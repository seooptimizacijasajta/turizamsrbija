...
export async function generateMetadata({ params }: { params: Promise<{ tema: string }> }) {
  ...
  return { title: `${t.title.en} | Turizam Srbija`, description: t.lead.en, alternates: { canonical: `/en/belgrade-info/${t.en_slug}`, languages: { "sr-Latn-RS": `/info-beograd/${t.slug}`, en: `/en/belgrade-info/${t.en_slug}`, de: `/de/belgrad-info/${t.en_slug}`, "x-default": `/info-beograd/${t.slug}` } } };
}
