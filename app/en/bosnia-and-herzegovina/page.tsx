...
const CAT = catById('bosna')!;
const ALT = { "sr-Latn-RS": "/bosna-i-hercegovina", en: "/en/bosnia-and-herzegovina", de: "/de/bosnien-herzegowina", "x-default": "/bosna-i-hercegovina" };
...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    alternates: { canonical: "/en/bosnia-and-herzegovina".replace("//", "/"), languages: ALT },
    openGraph: { title, description: lead, images: [CAT.hero] },
  };
}

export default async function Page() {
  const posts = await getPostsByCategory('bosna');
