...
export async function generateMetadata({ params }: { params: Promise<{ neighborhood: string }> }) {
  ...
  return { title: `Belgrade apartments ${a.en} — daily rentals | Turizam Srbija`, description: `Apartments and daily rentals in ${a.en}, Belgrade. Verified stays with photos, map and direct host contact, no guest commission.`, alternates: { canonical: `/en/belgrade-apartments/${neighborhood}`, languages: { "sr-Latn-RS": `/apartmani-beograd/${neighborhood}`, en: `/en/belgrade-apartments/${neighborhood}`, de: `/de/belgrad-apartments/${neighborhood}`, "x-default": `/apartmani-beograd/${neighborhood}` } } };
}
