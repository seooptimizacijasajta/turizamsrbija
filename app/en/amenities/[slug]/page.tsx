...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return { title: `${a.en} — accommodation in Serbia | Turizam Srbija`, description: `Find accommodation in Serbia: ${a.en.toLowerCase()}. Apartments, villas, hotels and ethno homes with filters and reviews.`, alternates: { canonical: `/en/amenities/${slug}` } };
}
