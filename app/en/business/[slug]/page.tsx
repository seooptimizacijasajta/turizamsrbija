...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return { title: `${b.name}${b.city ? " — " + b.city : ""} | Turizam Srbija`, description: (b.desc.en || b.desc.sr || b.name).slice(0, 160), alternates: { canonical: `/en/business/${slug}`, languages: { "sr-Latn-RS": `/firma/${slug}`, en: `/en/business/${slug}`, de: `/de/firma/${slug}`, "x-default": `/firma/${slug}` } } };
}
