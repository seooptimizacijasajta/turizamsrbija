...
export const metadata: Metadata = {
  title: "Where to go on holiday in Serbia? Best places & ideas | Turizam Srbija",
  description: "Where to go in Serbia — mountains, lakes, rivers, spas and ethno villages. The finest destinations and ideas for summer, winter and weekend breaks, with no guest commission.",
