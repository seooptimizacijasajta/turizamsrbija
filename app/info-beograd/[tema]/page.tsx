...
export async function generateMetadata({ params }: { params: Promise<{ tema: string }> }) {
  ...
  return { title: `${t.title.sr} | Turizam Srbija`, description: t.lead.sr, alternates: { canonical: `/info-beograd/${t.slug}`, languages: { "sr-Latn-RS": `/info-beograd/${t.slug}`, en: `/en/belgrade-info/${t.en_slug}`, de: `/de/belgrad-info/${t.en_slug}`, "x-default": `/info-beograd/${t.slug}` } } };
}
