...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return { title: `${a.sr} — smeštaj u Srbiji | Turizam Srbija`, description: `Pronađite smeštaj u Srbiji: ${a.sr.toLowerCase()}. Apartmani, vile, hoteli i etno domaćinstva sa filterom i recenzijama.`, alternates: { canonical: `/pogodnosti/${slug}` } };
}
